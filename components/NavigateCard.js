...
const NavigateCard = () => {
    ...
    return (
        <SafeAreaView style={tailwind`bg-white flex-1`}>
            <Text style={tailwind`text-center py-6 text-xl`}>Good Morning, Rcl8008</Text>
            ...
            <View style={tailwind`flex-row bg-white justify-evenly py-2 mt-auto border-t border-gray-100`}>
                <TouchableOpacity 
                    ...
                    style={tailwind`flex-row bg-black justify-between w-24 px-4 py-3 rounded-full`}
                >
                    <Icon name="car" type='font-awesome' color="white" size={16} />
                    <Text style={tailwind`text-white text-center`}>Rides</Text>
                </TouchableOpacity>

                <TouchableOpacity style={tailwind`flex-row justify-between w-24 px-4 py-3 rounded-full`}>
